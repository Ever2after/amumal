...
class DBHelper {
  ...
  Future<Database> get database async {
    ...
    _db = openDatabase(
      ...
      // 데이터베이스가 처음 생성될 때, memo를 저장하기 위한 테이블을 생성합니다.
      onCreate: (db, version) {
        return db.execute(
          "CREATE TABLE memos(id TEXT PRIMARY KEY, title TEXT, author TEXT, text TEXT, image TEXT, createTime TEXT, editTime TEXT)",
        );
      },
